...
import com.igorkohsin.backend.payload.request.LoginRequest;
import com.igorkohsin.backend.payload.request.SignupRequest;
import com.igorkohsin.backend.payload.response.MessageResponse;
import com.igorkohsin.backend.payload.response.UserInfoResponse;
import com.igorkohsin.backend.repository.RoleRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        //roleRepository.insert(new Role("9999", Roles.USER));
